...
This is a hub page for all notes related to **event-driven architecture**. Obsidian will automatically show backlinks below.
...
- Use this page to see all notes about event-driven architecture in one place
